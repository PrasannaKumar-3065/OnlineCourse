...
$query=mysqli_query($bd, "SELECT * FROM course WHERE courseCode='$courseid'");
if(mysqli_num_rows($query)>0)
{
$num=mysqli_fetch_array($query);
$extra="enroll-history-reg.php";//
$_SESSION['login']=$_POST['courseid'];
$_SESSION['id']=$num['courseCode'];
$_SESSION['cname']=$num['studentName'];
