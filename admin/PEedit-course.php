...
$ret=mysqli_query($bd, "update pecourse set courseCode='$coursecode',courseName='$coursename',noofSeats='$seatlimit',updationDate='$currentTime' where id='$id'");
if($ret)
{
...
<?php
$sql=mysqli_query($bd, "select * from pecourse where id='$id'");
$cnt=1;
