...
{
$sql=mysqli_query($bd, "SELECT * FROM  courseenrolls inner join course on course.id=courseenrolls.course where courseenrolls.department='".$_POST['department']."' && courseenrolls.semester='".$_POST['semester']."' && courseenrolls.batch='".$_POST['batch']."' && course.regulation='".$_POST['regulation']."' ");
...
header("location:enroll-history-dsbr.php");
}
else
{
$_SESSION['msg']="Error :invalid dept or semester , batch,reg. Please Enter a correctly !!";
}
}
?>
