                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table" id="enrolltable">
                                    <thead>
                                        <?php
                                            ...
                                            ?> <tr>
                                            <th><?php echo htmlentities($col['ssem']); ?>semester --
                                                <?php echo htmlentities($col['sdept']); ?></th>
                                        </tr>
                                        <?php
                                                $cnt++;
                                            } ?>
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = mysqli_query($bd, "select studentRegno as sregno,studentName as sname, creditsum as scredit from totalcredits where semester='" . $_SESSION['sem'] . "' && batch='" . $_SESSION['bat'] . "' && department='" . $_SESSION['dept'] . "' order by studentRegno");
                                            $cnt = 1;
                                ...
                                <form>
                                    <button type="submit" id="downloadexcel" name="export" class=btn-btn-info"
