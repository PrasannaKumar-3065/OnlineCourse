...
$sql = mysqli_query($bd, "Select * from course where department = '".$_POST["dept"]."' and semester = ".$_POST["semester"]." and batch = '".$_POST["batch"]."' ");
