...
{
$sql=mysqli_query($bd, "SELECT StudentRegno FROM students where department='".$_POST['department']."'  && batch='".$_POST['batch']."' ");
...
{
$_SESSION['msg']="Error :Wrong dept or batch Please Enter a correctly !!";
}
}
?>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Dept-batch selection</h1>
                    </div>
                </div>
                <div class="row" >
