...
{
$sql=mysqli_query($bd, "SELECT password FROM tutors where password='".md5($_POST['cpass'])."' && username='".$_SESSION['tlogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
  if(strcmp($_POST['newpass'],$_POST['cpass'])!=0){
    $con=mysqli_query($bd, "update tutors set password='".md5($_POST['newpass'])."' where username='".$_SESSION['tlogin']."'");
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Tutor Change Password </h1>
                    </div>
                </div>
                <div class="row" >
